...
export const foodGroups: FoodGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        tags: ['Breakfast'],
        specialityTags: ['Not published'],
        details: 'A different place from Taj Holiday Village\'s in-house Caravela restaurant. Full details in the 17 September panel.',
      },
      {
        status: 'Scheduled · 17 Sep',
        name: 'Confeitaria 31 de Janeiro',
        tags: ['Bakery, morning'],
        specialityTags: ['Patties (veg/prawn/chicken), chicken-cheese roll'],
        details: '~₹50 estimate from low published per-item prices.',
    ...
    items: [
      {
        ...
        name: 'Kokni Kanteen',
        tags: ['Lunch'],
        specialityTags: ['Goan/Konkani seafood thalis'],
        details: 'Cost not yet estimated. Full details in the 17 September panel.',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: 'Viva Panjim',
        tags: ['Dinner'],
        specialityTags: ['Crab xec-xec, prawn vindaloo, bebinca'],
        details: 'Cost not yet estimated. Full details in the 16 September panel.',
        links: [
      ...
      },
      {
        ...
        tags: ['Dinner'],
        specialityTags: ['Gastrobar — cocktails & small plates'],
        details: 'Dr. D.D.R.S. Road, Panjim. Phone +91 80105 21438. Full details in the 17 September panel.',
        links: [
    ...
    items: [
      {
        ...
        details: 'E-250 Gomes Pereira Road, Altinho, Panjim. Phone +91 98221 28885. No published hours found.',
      },
      {
        status: 'Not currently scheduled',
        name: 'K-Bar & Resto',
